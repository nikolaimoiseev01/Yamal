<section id="recipes" class="safe-area-wrap py-10 bg-gray-500 rounded-44 mb-20">
    <div class="content">
        <div class="flex gap-4 items-center mb-8">
            <h2 class="text-bright-500">Рецепты</h2>
            <svg wire:loading aria-hidden="true" class="w-8 h-8 text-bright-500 animate-spin  fill-black-500"
