<x-right-card name="product-right-card">
    <div wire:loading class="h-full w-full flex items-center justify-center">
        <svg aria-hidden="true" class="w-8 h-8 text-bright-500 animate-spin fill-black-500"
    ...
    @if($product ?? null)
        <div wire:loading.remove class="flex flex-col gap-6 relative">
            <x-heroicon-o-x-mark class="absolute text-black-500 w-8 top-4 right-4 cursor-pointer"
