<div x-data="{ isOpen: false }" class="relative md:hidden">
    ...
    <div
        ...
        class="absolute top-1/2 -translate-y-1/2 right-0 w-64 bg-white rounded-lg p-2 flex items-center space-x-2"
    >
        <input
            type="text"
            ...
            placeholder="Поиск..."
        />
        <x-heroicon-o-magnifying-glass wire:click.prevent="search()" class="w-6 h-6 text-black-500 cursor-pointer" />
    </div>
</div>
