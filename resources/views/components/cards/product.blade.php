<div lazy="true" wire:key="{{$product['id']}}"
    ...
    <a x-on:click="$dispatch('open-right-card', 'product-{{$product['id']}}-right-card')" class="w-full bg-gray-300 py-2 px-5 flex gap-4 rounded-[20px] items-center justify-center">
        Подробнее
